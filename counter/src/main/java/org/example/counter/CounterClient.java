...
import org.example.counter.rpc.CounterOutter.IncrementAndGetRequest;
...
public class CounterClient {
    ...
    public static void main(final String[] args) throws Exception {
        if (args.length != 2) {
            System.out.println("Usage : java org.example.counter.CounterClient {groupId} {conf}");
            System.out
                .println("Example: java org.example.counter.CounterClient counter 127.0.0.1:8081,127.0.0.1:8082,127.0.0.1:8083");
            System.exit(1);
        }
