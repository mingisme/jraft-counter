...
import org.example.counter.rpc.CounterGrpcHelper;
import org.example.counter.rpc.CounterOutter.ValueResponse;
import org.example.counter.rpc.GetValueRequestProcessor;
import org.example.counter.rpc.IncrementAndGetRequestProcessor;
...
public class CounterServer {
    ...
    public static void main(final String[] args) throws IOException {
        if (args.length != 4) {
            System.out
                .println("Usage : java org.example.counter.CounterServer {dataPath} {groupId} {serverId} {initConf}");
            System.out
                .println("Example: java org.example.counter.CounterServer /tmp/server1 counter 127.0.0.1:8081 127.0.0.1:8081,127.0.0.1:8082,127.0.0.1:8083");
            System.exit(1);
        }
